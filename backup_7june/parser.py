...
import tac #import three address code
import node as node
...
pp3 = parser.parse(p3)
backend.flatten_instructions(pp3, backend.labelmaker())
...
l = backend.labelmaker()
ife = parser.parse(ifeq)
backend.flatten_instructions(ife, backend.labelmaker())
backend.assemble(ife)
